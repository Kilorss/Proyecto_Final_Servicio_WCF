...
namespace DAL.DB
{
    public class cls_DB_DAL
    {
        ...
        private SqlConnection _Obj_CNX;       // objeto para la conexión a la DB
        ...
        private string _sNomTabla, _sNomSP, _sMsjErrorDB, _sIndAxn, _sValorScalar;
        ...
        public string sMsjErrorDB { get => _sMsjErrorDB; set => _sMsjErrorDB = value; }
